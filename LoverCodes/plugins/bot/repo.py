...
# from LoverCodes.utils.errors import capture_err
# import httpx 
# from pyrogram.types import InlineKeyboardButton, InlineKeyboardMarkup
...
#           InlineKeyboardButton("𝗢𝗪𝗡𝗘𝗥", url="https://t.me/Ownergit"),
#           ],
#                [
...
#               InlineKeyboardButton("︎𝗠𝗨𝗦𝗜𝗖", url=f"https://github.com/DAXXTEAM/LoverCodes"),
#               ],
#               [
...
#         response = await client.get("https://api.github.com/repos/DAXXTEAM/LoverCodes/contributors")
...
#         text = f"""[𝖱𝖤𝖯𝖮 𝖫𝖨𝖭𝖪](https://github.com/DAXXTEAM/LoverCodes) | [𝖦𝖱𝖮𝖴𝖯](https://t.me/HEROKUFREECC)
# | 𝖢𝖮𝖭𝖳𝖱𝖨𝖡𝖴𝖳𝖮𝖱𝖲 |
# ----------------
# {list_of_users}"""
