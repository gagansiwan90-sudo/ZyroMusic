...
from LoverCodes import app, YouTube
...
from LoverCodes.utils.formatters import convert_bytes
from LoverCodes.utils.inline.song import song_markup
...
async def song_download_cb(client, CallbackQuery, _):
    ...
    try:
        title, duration_min, duration_sec, thumb_image_path, vidid = await YouTube.details(yturl)
    except Exception as e:
         return await mystic.edit_text(f"Error extracting info: {e}")
